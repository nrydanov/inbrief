...
func NewFetcherServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FetcherServiceClient {
	...
	fetcherServiceMethods := fetcher.File_proto_fetcher_fetch_proto.Services().ByName("FetcherService").Methods()
	return &fetcherServiceClient{
		fetch: connect.NewClient[fetcher.FetchRequest, fetcher.FetchResponse](
			httpClient,
...
func (c *fetcherServiceClient) Fetch(ctx context.Context, req *connect.Request[fetcher.FetchRequest]) (*connect.Response[fetcher.FetchResponse], error) {
